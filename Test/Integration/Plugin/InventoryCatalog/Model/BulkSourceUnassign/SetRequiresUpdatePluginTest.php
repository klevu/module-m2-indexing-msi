...
namespace Klevu\IndexingMsi\Test\Integration\Plugin\InventoryCatalog\Model\BulkSourceUnassign;
...
/**
 * @covers \Klevu\IndexingMsi\Plugin\InventoryCatalog\Model\BulkSourceUnassign\SetRequiresUpdatePlugin::class
...
class SetRequiresUpdatePluginTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixtureName = 'Klevu Test: MSI BulkSourceUnassign RequiresUpdate Plugin';
        $this->fixtureApiKeys = [
            1 => 'klevu-1234567890',
            2 => 'klevu-9876543210',
        ];
    ...
    public function testPluginIsAttached_SimpleProduct_MultipleStocks(): void
    {
        ...
        /** @var BulkSourceUnassignInterface $bulkSourceUnassign */
        $bulkSourceUnassign = $this->objectManager->create(BulkSourceUnassignInterface::class);
        $bulkSourceUnassign->execute(
            skus: [
